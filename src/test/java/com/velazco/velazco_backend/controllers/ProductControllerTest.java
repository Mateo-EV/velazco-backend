...
public class ProductControllerTest {
    ...
    @Test
    @WithMockUser
    void shouldReturnLowStockProductsWithCount() throws Exception {
        ProductLowStockResponseDto.ProductData product1 = new ProductLowStockResponseDto.ProductData(1L, "Harina", 3);
        ProductLowStockResponseDto.ProductData product2 = new ProductLowStockResponseDto.ProductData(2L, "Azúcar", 7);

        ProductLowStockResponseDto responseDTO = new ProductLowStockResponseDto(2L, List.of(product1, product2));

        Mockito.when(productService.getLowStockProducts()).thenReturn(responseDTO);
        ...
        mockMvc.perform(get("/api/products/low-stock")
                ...
                .andExpect(jsonPath("$.products[0].name").value("Harina"))
                .andExpect(jsonPath("$.products[0].stock").value(3))
                .andExpect(jsonPath("$.products[1].id").value(2))
                .andExpect(jsonPath("$.products[1].name").value("Azúcar"))
