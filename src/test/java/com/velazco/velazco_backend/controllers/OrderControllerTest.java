...
public class OrderControllerTest {
  ...
  void shouldStartOrderSuccessfully() throws Exception {
    ...
    savedOrder.setDetails(List.of(
        OrderDetail.builder()
            .product(Product.builder().id(1L).price(BigDecimal.valueOf(10.0))
                .build())
            .quantity(2)
            .unitPrice(BigDecimal.valueOf(10.0))
            .build(),
        OrderDetail.builder()
            .product(Product.builder().id(3L).price(BigDecimal.valueOf(20.0))
                .build())
            .quantity(1)
    ...
    OrderStartResponseDto responseDto = OrderStartResponseDto.builder()
        ...
        .details(List.of(
            OrderStartResponseDto.DetailOrderStartResponseDto.builder()
                .product(OrderStartResponseDto.ProductOrderStartResponseDto
                    .builder().id(1L).build())
                .quantity(2)
                .unitPrice(BigDecimal.valueOf(10.0))
                .build(),
